    ...
    public static IHostBuilder CreateHostBuilder(string[] args) =>
        ...
        Host.CreateDefaultBuilder(args)
            .ConfigureAppConfiguration((hostContext, config) =>
            {
                ...
                //when the WebApplication.CreateBuilder method is called.The default ASP.NET Core web app templates call WebApplication.CreateBuilder.
...
#if EASYTEST
        //extraconfig = "AEC";
#elif RELEASE_PROD_SYKEHUSBYGG
        extraconfig = "Sykehusbygg_Prod";
#elif DEBUG_PROD_SYKEHUSBYGG
        extraconfig = "Sykehusbygg_Prod";
#elif RELEASE_DEMO_SYKEHUSBYGG
       extraconfig = "Sykehusbygg_Demo";
#elif DEBUG_DEMO_SYKEHUSBYGG
       extraconfig = "Sykehusbygg_Demo";
#elif RELEASE_SANDBOX_SYKEHUSBYGG
        extraconfig = "Sykehusbygg_Sandbox";
        ...
        extraconfig = "Sykehusbygg_Sandbox";
                ...
                {
                    config.AddJsonFile($"appsettings.{extraconfig}.json", optional: true, reloadOnChange: true);
                }
            })
